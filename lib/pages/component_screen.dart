...
import 'package:thesis_client/widgets/component_decoration.dart';
    ...
    return Expanded(
        child: ListView(
          ...
          children: [
            ...
            const Containment(),
            colDivider,
            NavigationGroup(scaffoldKey: scaffoldKey),
            colDivider,
            const Selection(),
            colDivider,
            const TextInputs()
...
class NavigationGroup extends StatelessWidget {
  const NavigationGroup({super.key, required this.scaffoldKey});
